...
--
-- Table structure for table `clotures_caisse`
--
...
CREATE TABLE `clotures_caisse` (
  ...
  `total_recettes` decimal(12,2) NOT NULL DEFAULT '0.00',
  `total_depenses` decimal(12,2) NOT NULL DEFAULT '0.00',
...
-- Dump completed on 2026-04-01 14:01:53
