...
CREATE TABLE `notes` (
  ...
  CONSTRAINT `notes_ibfk_1` FOREIGN KEY (`evaluation_id`) REFERENCES `evaluations` (`id`) ON DELETE CASCADE,
  CONSTRAINT `notes_ibfk_2` FOREIGN KEY (`eleve_id`) REFERENCES `inscriptions_eleve` (`id`)
...
-- Dump completed on 2026-04-01 14:01:46
