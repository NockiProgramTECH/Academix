...
CREATE TABLE `evaluations` (
  ...
  CONSTRAINT `evaluations_ibfk_1` FOREIGN KEY (`matiere_id`) REFERENCES `matiere` (`id_matiere`),
  CONSTRAINT `evaluations_ibfk_2` FOREIGN KEY (`classe_id`) REFERENCES `classes` (`id`)
